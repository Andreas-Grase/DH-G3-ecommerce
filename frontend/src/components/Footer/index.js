  ...
  return (
    <footer className="footer">
      ...
      <div className="linha-footer">
        <img className="footer-logo" src={logo} alt="Logo-Kabellos" />
      </div>
      {/* Linha 2 */}
      <div className="linha-footer">
        {/* Columna 1 */}
        ...
        <div className="footer-subrow-social">
          ...
          <div className="footer-subrow-newsletter">
            <form action="/" className="tbox">
              <legend className="form__content__legend">
                Novidades e Promoções
              </legend>
              <p className="texto-newsletter">
                Assine nossa newsletter para ficar por dentro das novidades e
      ...
      <div className="linha-footer linha-footer-final">
        <p className="coluna-copyright">
          {new Date().getFullYear()} &copy; EQUIPE 3 &nbsp; | &nbsp; Todos os
          direitos reservados
        </p>
      </div>
    </footer>
