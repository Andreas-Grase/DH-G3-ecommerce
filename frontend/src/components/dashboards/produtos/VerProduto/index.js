  ...
  return (
    <div style={{ width: "80%", margin: "5px" }}>
      <div className="header-section">
        ...
        <h1 className="title">Ver produto</h1>
      </div>
          ...
          <div className="card-product">
            ...
            <div className="product-content">
              ...
              <div className="product-detail">
                ...
                <p>
                  Cabelo seco à espera de um milagre? Sorte a sua que este
                  shampoo tem tudo para resolver o que você precisa. Nossa
                  fórmula com extrato de Óleo de Jojoba, Aloe Vera e Alga
                  Marinha australiana traz uma infusão de hidratação milagrosa
                  para deixar os cabelos limpos e macios. Traz uma infusão de
                  hidratação milagrosa. Deixa os cabelos limpos e macios.
