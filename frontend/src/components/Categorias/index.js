...
const Categorias = () => {
  return (
    <section id="produtos">
      ...
      <div id="ladoalado">
        <a href="shampoo.html">
          <img class="img-produtos1" src={barbearia} alt="shampoo" />
        </a>
        <a href="condicionador.html">
          <img class="img-produtos" src={cabelo} alt="condicionador" />
        </a>
        <a href="mascara.html">
          <img class="img-produtos1" src={lancamentos} alt="mascaras" />
        </a>
        <a href="cremes">
          <img class="img-produtos" src={pele} alt="cremes" />
        </a>
        <a href="barbearia">
          <img class="img-produtos1" src={unhas} alt="barbearia" />
        </a>
      </div>
    </section>
  );
